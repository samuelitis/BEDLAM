...
class Renderer:
    ...
    def visualize_tb(
        ...
        if app_images is not None:
            app_images = app_images.cpu()

        if smpl_images is not None:
            smpl_images = smpl_images.cpu()
        ...
        for i in range(nb_max_img):
            ...
            if app_images is not None:
                rend_imgs.append(app_images[i])

            rend_imgs.append(images[i])

            if pred_images is not None:
                rend_imgs.append(pred_images[i])

            if smpl_images is not None:
                rend_imgs.append(smpl_images[i])
        ...
        # if app_images is not None: nrow += 1
        # if smpl_images is not None: nrow += 1
        # if pred_images is not None: nrow += 1
